...
{
    public partial class frm_TR050OBOBN : System.Web.UI.Page
    {
        public string TheUrl = "";
        public const string REPORT_USERCODE = "TR050OBOBN";

        protected void Page_Init(object sender, EventArgs e)
        {
            //Label lb = (Label)Master.FindControl("lblFormTitle");
            //lb.Text = "Confirmation Bond Fx Instruction";
        }
        ...
        {
            //Response.Redirect("~/View/ReportViewer.aspx?report=TR050OBOBN&d=" + txtDealNo.Text.Trim());
