<%@ Page Language="C#" MasterPageFile="~/Content.Master" AutoEventWireup="true" CodeBehind="frm_TR051BONTH.aspx.cs" Inherits="TreasuryShadowSystem.Form.frm_TR051BONTH" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContent" runat="server">
    ...
    <div class="content-module">
	    ...
	    <div class="content-module-heading cf">
			...
			<h3 class="fl">Trade Confirmation</h3>
					    ...
					    <table border="0">
					        <tbody>					           
					            ...
					            <tr>
					                ...
					                <td colspan="3" class="td-field-large">
					                    <asp:CheckBox ID="NoSignBox" AutoPostBack="true" Text="No Sign" runat="server" />
                                    </td>
					            </tr>
					              <tr>
