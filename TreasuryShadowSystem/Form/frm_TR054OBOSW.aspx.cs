...
{
    public partial class frm_TR054OBOSW : System.Web.UI.Page
    {
        public string TheUrl = "";
        public const string REPORT_USERCODE = "TR054OBOSW";

        protected void Page_Init(object sender, EventArgs e)
        {
            //Label lb = (Label)Master.FindControl("lblFormTitle");
            //lb.Text = "Deal Ticket Swap";
        }
        ...
        {
            //Response.Redirect("~/View/ReportViewer.aspx?report=TR054OBOSW&d=" + txtDealNo.Text.Trim());
