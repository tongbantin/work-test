<%@ Page Language="C#" MasterPageFile="~/Content.Master" AutoEventWireup="true" CodeBehind="frm_TF026OBOTX.aspx.cs" Inherits="TreasuryShadowSystem.Form.frm_TF026OBOTX" Title="Untitled Page" %>
                                ...
                                <td>
                                    <table width="100%" border="0" cellpadding="5" cellspacing="0">
                                        <tr>
                                            ...
                                            <td width="60%" align="left"><asp:TextBox ID="txtBranch" placeholder="e.g. 01" runat="server"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidatorBranch" ControlToValidate="txtBranch" EnableClientScript="true" ErrorMessage="Field is required." runat="server"></asp:RequiredFieldValidator></td>
                                        </tr>
                                        <tr>
                                            <td align="right"><asp:Label ID="lblParam2" Text="Ref No." runat="server"></asp:Label></td>
                                            <td align="left"><asp:TextBox ID="txtRefNo" placeholder="e.g.1000311" runat="server"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidatorRefNo" ControlToValidate="txtRefNo" EnableClientScript="true" ErrorMessage="Field is required." runat="server"></asp:RequiredFieldValidator></td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContent" runat="server">
    <div class="content-module">
	    ...
	    <div class="content-module-heading cf">
			...
			<h3 class="fl">TAX Certificate</h3>
					    ...
					    <table border="0">
					        <tbody>
					            ...
					            <tr>
                                    ...
                                    <td class="td-display"><label for="simple-input">Ref No.</label></td>
					                <td class="td-field">
					                    <asp:TextBox ID="txtRef" placeholder="e.g.1000311" runat="server"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidatorPN" ControlToValidate="txtRef" EnableClientScript="true" ErrorMessage="*" runat="server"></asp:RequiredFieldValidator>
                                    </td>
					            </tr>
					              <tr>
