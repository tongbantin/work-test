<%@ Page Title="" Language="C#" MasterPageFile="~/Content.Master" AutoEventWireup="true" CodeBehind="frm_TR065DBOCM.aspx.cs" Inherits="TreasuryShadowSystem.Form.frm_TR065DBOCM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContent" runat="server">
    ...
    <div class="content-module">
	    ...
	    <div class="content-module-heading cf">
			...
			<h3 class="fl">REPO Margin Call Summary</h3>
			...
			<div  class="half-size-column fl">
					...
					<fieldset>
						...
						<p>
							...
							<input type="text" id="txtReportDate" runat="server" readonly class="round input-textbox-date" />
