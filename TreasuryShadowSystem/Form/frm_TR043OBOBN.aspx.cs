...
{
    public partial class frm_TR043OBOBN : System.Web.UI.Page
    {
        public string TheUrl = "";
        public const string REPORT_USERCODE = "TR043OBOBN";

        protected void Page_Init(object sender, EventArgs e)
        {
            //Label lb = (Label)Master.FindControl("lblFormTitle");
            //lb.Text = "Confirmation Bond(FX Buy)";
        }
        ...
        {
            //Response.Redirect("~/View/ReportViewer.aspx?report=TR043OBOBN&d=" + txtDealNo.Text.Trim());
