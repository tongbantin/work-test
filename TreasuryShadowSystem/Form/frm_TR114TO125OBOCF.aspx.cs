...
{
    public partial class frm_TR114TO125OBOCF : System.Web.UI.Page
    {
        ...
        {
            TheUrl = "../View/ReportViewer2.aspx?report=TR114TO125OBOCF";
            TheUrl += "&d=" + DealNoBox.Text + "&c=" + CustomerTypeBox.SelectedValue;
            Page.DataBind();
        }
    }
}
