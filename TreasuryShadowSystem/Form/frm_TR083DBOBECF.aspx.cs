...
{
    public partial class frm_TR083DBOBECF : System.Web.UI.Page
    {
        ...
        {
            TheUrl = "../View/ReportViewer2.aspx?report=TR083DBOBECF";
            TheUrl += "&b=" + txtBranch.Text + "&c=" + txtCustomer.Value + "&e=" + txtExecuteDate.Value;
            Page.DataBind();
        }
    }
}
