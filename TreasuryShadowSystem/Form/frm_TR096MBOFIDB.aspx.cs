...
{
    public partial class frm_TR096MBOFIDB : System.Web.UI.Page
    {
        public string TheUrl = "";
        public const string REPORT_USERCODE = "TR096MBOFIDB";
        ...
        {
            //Response.Redirect("~/View/ReportViewer.aspx?report=TR096MBOFIDB&b=" + txtBranch.Text + "&ex=" + calExecuteDate.SelectedDate.ToString("dd/MM/yyyy") + "&c=" + ddCost.SelectedValue);
