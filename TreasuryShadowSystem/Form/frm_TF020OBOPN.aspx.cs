...
{
    public partial class frm_TF020OBOPN : System.Web.UI.Page
    {

        public string TheUrl = "";
        public const string REPORT_USERCODE = "TF020OBOPN";

        protected void Page_Init(object sender, EventArgs e)
        {
            //Label lb = (Label)Master.FindControl("lblFormTitle");
            //lb.Text = "PROMISSORY NOTE";
        }
        ...
        {
            //Response.Redirect("~/View/ReportViewer.aspx?report=TF020OBOPN&b=" + txtBranch.Text + "&d=" + txtPN.Text);
