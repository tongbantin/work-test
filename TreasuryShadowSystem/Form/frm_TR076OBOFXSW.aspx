<%@ Page Title="" Language="C#" MasterPageFile="~/Content.Master" AutoEventWireup="true" CodeBehind="frm_TR076OBOFXSW.aspx.cs" Inherits="TreasuryShadowSystem.Form.frm_TR076OBOFXSW" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContent" runat="server">
    <div class="content-module">
	    ...
	    <div class="content-module-heading cf">
			...
			<h3 class="fl">FX SWAP Confirmation</h3>
