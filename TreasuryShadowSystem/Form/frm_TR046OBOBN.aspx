<%@ Page Language="C#" MasterPageFile="~/Content.Master" AutoEventWireup="true" CodeBehind="frm_TR046OBOBN.aspx.cs" Inherits="TreasuryShadowSystem.Form.frm_TR046OBOBN" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContent" runat="server">
    ...
    <div class="content-module">
	    ...
	    <div class="content-module-heading cf">
			...
			<h3 class="fl">Confirmation Bond(FX Sell)</h3>
