<%@ Page Language="C#" MasterPageFile="~/Content.Master" AutoEventWireup="true" CodeBehind="frm_TR068FMFIOUT1.aspx.cs" Inherits="TreasuryShadowSystem.Form.frm_TR068FMFIOUT1" Title="Untitled Page" %>
					...
					<fieldset>
					    <table border="0">
					        <tbody>
					            ...
					            <tr>
					                <td class="style1"><label for="simple-input">Branch:</label></td>
					                <td colspan="3" class="td-field">
					                    <asp:TextBox ID="txtBranch" placeholder="e.g.01" runat="server" CssClass="round input-form-textbox"></asp:TextBox>
					                </td>
					            </tr>
					            <tr>
					                <td class="style1"><label for="simple-input">Transaction Date From:</label></td>
					            ...
					            <tr>
					                <td class="style1"><label for="simple-input">Deal no. From:</label></td>
