...
{
    public partial class frm_TR053OBOBN : System.Web.UI.Page
    {
        public string TheUrl = "";
        public const string REPORT_USERCODE = "TR053OBOBN";

        protected void Page_Init(object sender, EventArgs e)
        {
            //Label lb = (Label)Master.FindControl("lblFormTitle");
            //lb.Text = "Deal Ticket Fixed Income";
        }
        ...
        {
            //Response.Redirect("~/View/ReportViewer.aspx?report=TR053OBOBN&d=" + txtDealNo.Text.Trim());
