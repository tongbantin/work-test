<%@ Page Language="C#" MasterPageFile="~/Content.Master" AutoEventWireup="true" CodeBehind="frm_TR057DBOSL.aspx.cs" Inherits="TreasuryShadowSystem.Form.frm_TR057DBOSL" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContent" runat="server">
    <div class="content-module">
	    ...
	    <div class="content-module-heading cf">
			...
			<h3 class="fl">SoftLoan Payment Daily Report</h3>
					        ...
					        <tbody>
					            ...
					            <tr>
					                ...
					                <td colspan="3" class="td-field">
					                    <input type="text" id="txtExecuteDate" runat="server" class="round input-form-textbox" />					                    
                                    </td>
					            </tr>
					              <tr>
