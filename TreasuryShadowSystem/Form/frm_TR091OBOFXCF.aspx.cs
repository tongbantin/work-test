...
{
    public partial class frm_TR091OBOFXCF : System.Web.UI.Page
    {
        private static ILog Log = log4net.LogManager.GetLogger(typeof(frm_TR091OBOFXCF));
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            DataSet norpt = Model_RPT_TR091OBOFXCF.checkCustNoReport(Config.ConnectionString, txtDealNo.Text.Trim(), custnorpt);
            if (norpt != null)
            {
                TheUrl = "../View/ReportViewer2.aspx?report=TR091OBOFXCF";
                TheUrl += "&d=0";
            }
            else {
                TheUrl = "../View/ReportViewer2.aspx?report=TR091OBOFXCF";
        ...
        protected void btnViewPass_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet ds = Model_RPT_TR091OBOFXCF.getDataSet(Config.ConnectionString, Dealno);
        ...
        protected void btnSendMail_Click(object sender, EventArgs e)
        {
            ...
            {                
                ...
                string filename = "FX_";
                string tableName = "TB_TR091OBOFXCF";
                
                ReportClass report = new RPT_TR091OBOFXCF();
                string[] encrypt;
                string[] ctype;
                string[] zipList;
                ...
                {                 
                    ...
                    zipList = new string[ds.Tables[0].Rows.Count];
                        ...
                        for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                        {
                            ...
                            encrypt[i] = ds.Tables[0].Rows[i]["ENCRYPT"].ToString();
                            ctype[i] = ds.Tables[0].Rows[i]["CTYPE"].ToString();
                            filename += ds.Tables[0].Rows[i]["NEARDEALNO"].ToString() +"-"+ ds.Tables[0].Rows[i]["FARDEALNO"].ToString();
        ...
        public void Encryption(string filename, string[] encrypt , string[] ctype)
        {
            try
            {
                Log.Info(" TR091OBOFXCF Encryption ");
