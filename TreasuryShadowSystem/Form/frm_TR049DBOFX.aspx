<%@ Page Language="C#" MasterPageFile="~/Content.Master" AutoEventWireup="true" CodeBehind="frm_TR049DBOFX.aspx.cs" Inherits="TreasuryShadowSystem.Form.frm_TR049DBOFX" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContent" runat="server">
    <div class="content-module">
	    ...
	    <div class="content-module-heading cf">
			...
			<h3 class="fl">Foreign Exchange Outstanding</h3>
