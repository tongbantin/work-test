<%@ Page Language="C#" MasterPageFile="~/Content.Master" AutoEventWireup="true" CodeBehind="frm_TR079DFFITD.aspx.cs" Inherits="TreasuryShadowSystem.Form.frm_TR079DFFITD" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContent" runat="server">
    <div class="content-module">
	    ...
	    <div class="content-module-heading cf">
			...
			<h3 class="fl">079-Fixed Income Daily Transaction by Trading Dealers</h3>
					    ...
					    <table border="0">
					        <tbody>
					            ...
					            <tr>
					                ...
					                <td class="td-field" colspan="3"><input type="text" id="txtFromDate" size="15" runat="server" class="round input-form-textbox" /> ถึง  
					                <input type="text" id="txtToDate" runat="server" size="15" class="round input-form-textbox" /></td>					                
					            </tr>
					              <tr>
