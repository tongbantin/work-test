<%@ Page Language="C#" MasterPageFile="~/Content.Master" AutoEventWireup="true" CodeBehind="frm_TF048OBOBE.aspx.cs" Inherits="TreasuryShadowSystem.Form.frm_TF048OBOBE" Title="Untitled Page" %>
                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellpadding="5" cellspacing="0">
                                        ...
                                        <tr>
                                            <td align="right"><asp:Label ID="lblParam3" Text="PN No. " runat="server"></asp:Label></td>
                                            <td align="left"><asp:TextBox ID="txtPN" placeholder="e.g.1000311" runat="server"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidatorPN" ControlToValidate="txtPN" EnableClientScript="true" ErrorMessage="Field is required." runat="server"></asp:RequiredFieldValidator></td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContent" runat="server">
    <div class="content-module">
	    ...
	    <div class="content-module-heading cf">
			...
			<h3 class="fl">Bill of Exchange</h3>
