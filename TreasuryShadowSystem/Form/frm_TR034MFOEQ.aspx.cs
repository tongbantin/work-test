...
{
    public partial class frm_TR034MFOEQ : System.Web.UI.Page
    {
        public string TheUrl = "";
        public const string REPORT_USERCODE = "TR034MFOEQ";

        protected void Page_Init(object sender, EventArgs e)
        {
            //Label lb = (Label)Master.FindControl("lblFormTitle");
            //lb.Text = "Report TR034MFOEQ";
        }
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
           ...
           // Response.Redirect("~/View/ReportViewer.aspx?report=TR034MFOEQ&b=" + txtBranch.Text + "&ex=" + calExecuteDate.SelectedDate.ToString("dd/MM/yyyy"));
