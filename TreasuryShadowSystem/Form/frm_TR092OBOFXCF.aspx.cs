...
{
    public partial class frm_TR092OBOFXCF : System.Web.UI.Page
    {
        public string TheUrl = "";
        private static ILog Log = log4net.LogManager.GetLogger(typeof(frm_TR092OBOFXCF));
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            DataSet norpt = Model_RPT_TR092OBOFXCF.checkCustNoReport(Config.ConnectionString, txtDealNo.Text.Trim(), custnorpt);
            if (norpt != null)
            {
                TheUrl = "../View/ReportViewer2.aspx?report=TR092OBOFXCF";
                TheUrl += "&d=0";
            }
            else
            {
        ...
        protected void btnViewPass_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet ds = Model_RPT_TR092OBOFXCF.getDataSet(Config.ConnectionString, Dealno);
        ...
        protected void btnSendMail_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string filename = "FX_";
                string tableName = "TB_TR092OBOFXCF";
                ReportClass report = new RPT_TR092OBOFXCF();
                string[] encrypt;
                string[] ctype;
                string[] zipList;
        ...
        public void Encryption(string filename, string[] encrypt, string[] ctype)
        {
            try
            {
                Log.Info(" TR092OBOFXCF Encryption ");
