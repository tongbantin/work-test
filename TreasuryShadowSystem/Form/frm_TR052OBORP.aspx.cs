...
{
    public partial class frm_TR052OBORP : System.Web.UI.Page
    {

        public string TheUrl = "";
        public const string REPORT_USERCODE = "TR052OBORP";

        protected void Page_Init(object sender, EventArgs e)
        {
            //Label lb = (Label)Master.FindControl("lblFormTitle");
            //lb.Text = "Deal Ticket Repurchase Agreement";
        }
        ...
        {
            //Response.Redirect("~/View/ReportViewer.aspx?report=TR052OBORP&d=" + txtDealNo.Text.Trim());
