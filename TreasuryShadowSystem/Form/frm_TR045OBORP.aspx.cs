...
{
    public partial class frm_TR045OBORP : System.Web.UI.Page
    {
        public string TheUrl = "";
        public const string REPORT_USERCODE = "TR045OBORP";

        protected void Page_Init(object sender, EventArgs e)
        {
            //Label lb = (Label)Master.FindControl("lblFormTitle");
            //lb.Text = "REPO Confirmation";
        }
        ...
        {
            //Response.Redirect("~/View/ReportViewer.aspx?report=TR045OBORP&d=" + txtDealNo.Text.Trim());
