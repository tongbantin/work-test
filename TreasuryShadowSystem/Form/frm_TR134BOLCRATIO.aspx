<%@ Page Title="" Language="C#" MasterPageFile="~/Content.Master" AutoEventWireup="true" CodeBehind="frm_TR134BOLCRATIO.aspx.cs" Inherits="TreasuryShadowSystem.Form.frm_TR134BOLCRATIO" %>
					            ...
					            <tr>
					                ...
					                <td> <div>
					                    <asp:RadioButtonList ID="ChoiceBox" RepeatDirection="Horizontal" CellPadding="0" CellSpacing="0" Width="500" runat="server">
					                        <asp:ListItem Text="Feature" Value="Feature" Selected="True"></asp:ListItem>
					                        <asp:ListItem Text="Summary" Value="Summary"></asp:ListItem>
					                        <asp:ListItem Text="By Nationality" Value="ByNationality"></asp:ListItem>
					                        <asp:ListItem Text="By Customer Type" Value="ByCustomer"></asp:ListItem>
