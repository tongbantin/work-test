<%@ Page Language="C#" MasterPageFile="~/Content.Master" AutoEventWireup="true" CodeBehind="frm_TR096MBOFIDB.aspx.cs" Inherits="TreasuryShadowSystem.Form.frm_TR096MBOFIDB" Title="Untitled Page" %>
                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellpadding="5" cellspacing="0">
                                        ...
                                        <tr>
                                            <td align="right"><asp:Label ID="lblBU" Text="BU " runat="server"></asp:Label></td>
                                            <td align="left"><asp:DropDownList ID="ddCost" runat="server"></asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContent" runat="server">
    ...
    <div class="content-module">
	    ...
	    <div class="content-module-heading cf">
			...
			<h3 class="fl">Investment Summary - Debenture Issue</h3>
					    ...
					    <table border="0">
					        <tbody>
					            <tr>
					                ...
					                <td class="td-field"><input type="text" id="txtExecuteDate"  runat="server" class="round input-textbox-date" /></td>
					            </tr>
					            <tr>
					                <td class="td-display"><label for="simple-input">BU:</label></td>
					                <td class="td-field" colspan="3">
					                    <asp:DropDownList ID="ddCost" runat="server" CssClass="round input-form-dropdownlist"></asp:DropDownList>
					                </td>
					            </tr>
					            <tr>
