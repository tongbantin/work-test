...
{
    public partial class frm_TR051TAXSUMMARY : System.Web.UI.Page
    {
        ...
        {
            TheUrl = "../View/ReportViewer2.aspx?report=TR051TAXSUMMARY";
            TheUrl += "&f=" + txtFromDate.Value + "&t=" + txtToDate.Value;
            Page.DataBind();
        }
    }
}
