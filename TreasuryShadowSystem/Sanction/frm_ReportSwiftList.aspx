<%@ Page Language="C#" MasterPageFile="~/Content.Master" AutoEventWireup="true" CodeBehind="frm_ReportSwiftList.aspx.cs" Inherits="TreasuryShadowSystem.Sanction.frm_ReportSwiftList" Title="Untitled Page" %>
	                        ...
	                        <tr>
	                            ...
	                            <td>
                                    <select id="status">
                                        ...
                                        <option value="WAITING_TO_SEND">Waiting to send</option>
                                        ...
                                        <option value="TRANSFER_TO_SWIFT">Transfer to SWIFT</option>
                                    </select>
	                            </td>
	                        </tr>    
	                        <tr>
                ...
                <script type="text/javascript">
                    ...
                    $(document).ready(function() {
                        ...
                        $('#SwiftTableContainer').jtable({
                            ...
                            actions: {
                                listAction: '<%=Config.Website %>/Sanction/frm_ReportSwiftList.aspx/SWIFTList', 
                                updateAction: '#' 
                            },
                            fields: {
                                SWIFTMSGID: {
