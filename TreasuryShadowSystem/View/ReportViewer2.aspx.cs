                ...
                if (!IsPostBack)
                {
                    ...
                    switch (Request.QueryString["report"])
                    {
                        ...
                        case "UNWINDREPORT":
                              ...
                              listrpt = Model_RPT_UNWINDREPORT.getReport(Config.ConnectionString, symbol4, producttype4, stnid);
                              break;   
                    }
                    ...
                    if ((rpt != null) || (listrpt.Count > 0))
                    {
                        ...
                        else if (Request.QueryString["isreport"] != null)
                        {
                            if ((Request.QueryString["reportname"] != null) && (!Request.QueryString["reportname"].Equals("")))
                            {
                                ...
                                string pathfolder = Server.MapPath("~/Temporary/STNReport/" + Request.QueryString["symbol"]+"/");
                                ...
                                if (listrpt.Count > 0) {
                                    ...
                                    foreach(ReportClass r in listrpt){
                                        ...
                                        rpt.ExportToDisk(ExportFormatType.PortableDocFormat, pathfolder + Request.QueryString["reportname"] + "_" + runningno + ".pdf");
                                        string url = "http://" + HttpContext.Current.Request.Url.Authority + HttpContext.Current.Request.ApplicationPath + "/Temporary/STNReport/" + Request.QueryString["symbol"] + "/" + Request.QueryString["reportname"] + "_" + runningno + ".pdf";
                                        //string path = "/Temporary/Report/" + Request.QueryString["reportname"] + "_" + runningno + ".pdf";
