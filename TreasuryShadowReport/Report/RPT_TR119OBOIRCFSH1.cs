...
namespace KKB.Treasury.TreasuryReport.Report {
    ...
    public class RPT_TR119OBOIRCFSH : ReportClass {
        
        public RPT_TR119OBOIRCFSH() {
        }
        
        public override string ResourceName {
            get {
                return "RPT_TR119OBOIRCFSH.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "KKB.Treasury.TreasuryReport.Report.RPT_TR119OBOIRCFSH.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_TR119OBOIRCFSH : Component, ICachedReport {
        
        public CachedRPT_TR119OBOIRCFSH() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_TR119OBOIRCFSH rpt = new RPT_TR119OBOIRCFSH();
            rpt.Site = this.Site;
            return rpt;
        }
