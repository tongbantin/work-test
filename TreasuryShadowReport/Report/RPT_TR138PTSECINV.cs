...
namespace KKB.Treasury.TreasuryReport.Report {
    ...
    public class RPT_TR138PTSECINV : ReportClass {
        
        public RPT_TR138PTSECINV() {
        }
        
        public override string ResourceName {
            get {
                return "RPT_TR138PTSECINV.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "KKB.Treasury.TreasuryReport.Report.RPT_TR138PTSECINV.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_TR138PTSECINV : Component, ICachedReport {
        
        public CachedRPT_TR138PTSECINV() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_TR138PTSECINV rpt = new RPT_TR138PTSECINV();
            rpt.Site = this.Site;
            return rpt;
        }
