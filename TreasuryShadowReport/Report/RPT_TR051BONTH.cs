...
namespace KKB.Treasury.TreasuryReport.Report {
    ...
    public class RPT_TR051BONTH : ReportClass {
        
        public RPT_TR051BONTH() {
        }
        
        public override string ResourceName {
            get {
                return "RPT_TR051BONTH.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "KKB.Treasury.TreasuryReport.Report.RPT_TR051BONTH.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_TR051BONTH : Component, ICachedReport {
        
        public CachedRPT_TR051BONTH() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_TR051BONTH rpt = new RPT_TR051BONTH();
            rpt.Site = this.Site;
            return rpt;
        }
