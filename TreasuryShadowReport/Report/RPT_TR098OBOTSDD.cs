...
namespace KKB.Treasury.TreasuryReport.Report {
    ...
    public class RPT_TR098OBOTSDD : ReportClass {
        
        public RPT_TR098OBOTSDD() {
        }
        
        public override string ResourceName {
            get {
                return "RPT_TR098OBOTSDD.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "KKB.Treasury.TreasuryReport.Report.RPT_TR098OBOTSDD.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_TR098OBOTSDD : Component, ICachedReport {
        
        public CachedRPT_TR098OBOTSDD() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_TR098OBOTSDD rpt = new RPT_TR098OBOTSDD();
            rpt.Site = this.Site;
            return rpt;
        }
