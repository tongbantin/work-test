...
namespace KKB.Treasury.TreasuryReport.Report {
    ...
    public class RPT_TR138INV : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "KKB.Treasury.TreasuryReport.Report.RPT_TR138INV.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_TR138INV : Component, ICachedReport {
        
        public CachedRPT_TR138INV() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_TR138INV rpt = new RPT_TR138INV();
            rpt.Site = this.Site;
            return rpt;
        }
