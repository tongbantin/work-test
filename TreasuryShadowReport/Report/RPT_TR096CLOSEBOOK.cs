...
namespace KKB.Treasury.TreasuryReport.Report {
    ...
    public class RPT_TR096CLOSEBOOK : ReportClass {
        
        public RPT_TR096CLOSEBOOK() {
        }
        
        public override string ResourceName {
            get {
                return "RPT_TR096CLOSEBOOK.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "KKB.Treasury.TreasuryReport.Report.RPT_TR096CLOSEBOOK.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_TR096CLOSEBOOK : Component, ICachedReport {
        
        public CachedRPT_TR096CLOSEBOOK() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_TR096CLOSEBOOK rpt = new RPT_TR096CLOSEBOOK();
            rpt.Site = this.Site;
            return rpt;
        }
