...
namespace KKB.Treasury.TreasuryReport.Report {
    ...
    public class RPT_TR118OBOIRCFPF : ReportClass {
        
        public RPT_TR118OBOIRCFPF() {
        }
        
        public override string ResourceName {
            get {
                return "RPT_TR118OBOIRCFPF.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "KKB.Treasury.TreasuryReport.Report.RPT_TR118OBOIRCFPF.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_TR118OBOIRCFPF : Component, ICachedReport {
        
        public CachedRPT_TR118OBOIRCFPF() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_TR118OBOIRCFPF rpt = new RPT_TR118OBOIRCFPF();
            rpt.Site = this.Site;
            return rpt;
        }
