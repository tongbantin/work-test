...
namespace KKB.Treasury.TreasuryReport.Report {
    ...
    public class RPT_TR115OBOIRCFLI : ReportClass {
        
        public RPT_TR115OBOIRCFLI() {
        }
        
        public override string ResourceName {
            get {
                return "RPT_TR115OBOIRCFLI.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "KKB.Treasury.TreasuryReport.Report.RPT_TR115OBOIRCFLI.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_TR115OBOIRCFLI : Component, ICachedReport {
        
        public CachedRPT_TR115OBOIRCFLI() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_TR115OBOIRCFLI rpt = new RPT_TR115OBOIRCFLI();
            rpt.Site = this.Site;
            return rpt;
        }
